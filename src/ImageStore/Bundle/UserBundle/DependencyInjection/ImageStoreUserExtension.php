...
namespace ImageStore\Bundle\UserBundle\DependencyInjection;
 ...
 */
class ImageStoreUserExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        */
        ...
        $factory->create('image_store_user', array(
            array(
                /*
                ...
                'services_prefix' => 'image_store_user',
                'routes_prefix' => 'image_store_user',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'ImageStore\Bundle\UserBundle\Entity\User',
                ...
                /*
                'group' => array(
                    'group_class' => 'ImageStore\Bundle\UserBundle\Entity\Group',
