...
namespace ImageStore\Bundle\UserSystem\AdminBundle\DependencyInjection;
 ...
 */
class ImageStoreUserSystemAdminExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'image_store_user_system_admin_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('image_store_user_system_admin', array(
            array(
                /*
                ...
                'services_prefix' => 'image_store_user_system_admin',
                'routes_prefix' => 'image_store_user_system_admin',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'ImageStore\Bundle\UserSystem\AdminBundle\Entity\User',
                ...
                /*
                'group' => array(
                    'group_class' => 'ImageStore\Bundle\UserSystem\AdminBundle\Entity\Group',
